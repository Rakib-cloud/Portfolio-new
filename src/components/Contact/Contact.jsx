  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
        ...
        {/* Google Map */}
        <div className="bg-[#0d081f] p-6 rounded-lg shadow-lg border border-gray-700 h-full">
          ...
          <div className="w-full h-[400px] rounded-lg overflow-hidden border border-gray-600">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d233667.49999999997!2d90.356331!3d23.684994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30adaaed80e18ba7%3A0xf2d28e0c4e1fc6b!2sBangladesh!5e0!3m2!1sen!2sus!4v1727692800000!5m2!1sen!2sus"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
              ...
              title="Location Map - Bangladesh"
            ></iframe>
          </div>
          <p className="text-gray-400 text-sm text-center mt-2">Bangladesh</p>
        </div>
      </div>
    </section>
  );
